        ...
        <div>
          ...
          <form onSubmit={handleAddCoffee}>
            <div className='grid grid-cols-1 gap-7 md:grid-cols-2'>
                ...
                <fieldset className="fieldset">
                    <legend className="fieldset-legend text-[16px] md:text-[18px] ">Category</legend>
                    <input type="text" name='category' className="input w-full border-none" placeholder="Enter Coffee Category" />
                </fieldset>
                <fieldset className="fieldset">
